...
function shuffle() {
    ...
    for (var i = 0; color_candidates.length > 0; i++) {
        shuffled_colors.push(color_candidates.splice(Math.floor(Math.random() * color_candidates.length), 1)[0]);
    }
}
                ...
                if (click_flag && !click_card.includes(card) && !clear_card.includes(card)) {
                    ...
                    if (click_card.length === 2) {
                        if (
                            ...
                            clear_card = clear_card.concat(click_card);
                            click_card = [];
                            console.log(clear_card, click_card);
