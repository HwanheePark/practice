    ...
    for (var i = 0; i < hor; i++) {
        ...
        for (var j = 0; j < ver; j++) {
            ...
            td.addEventListener('click', function(event) {
                ...
                var index_hor = Array.prototype.indexOf.call(tbody.children, this.parentNode);
                var index_ver = Array.prototype.indexOf.call(this.parentNode.children, this);
                if (dataset[index_hor][index_ver] === 1 || [`!`, `?`].includes(this.textContent)) {
                    return;
                }
                ...
                if (dataset[index_hor][index_ver] === `X`) {
                    ...
                    var surroundings_mines = surroundings.filter(function (v) {
                        return v === `X`;
                    }).length;
                    this.textContent = surroundings_mines || ``;

                    if (surroundings_mines === 0) {
                        ...
                        surrounding_cell.filter(function (v) {return !!v})
                            .forEach(function (sidecell) {
                                ...
                                var index_sidecell_ver = Array.prototype.indexOf.call(sidecell_tr, sidecell);
